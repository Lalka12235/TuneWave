...
def test_get_user_notification(notification_repo, user_data1):
    for i in range(15):
...
def test_add_notification(notification_repo, user_data1, user_data2 ):
    room_id = uuid.uuid4()
...
def test_mark_notification_as_read(notification_repo, user_data1):
    notification = notification_repo.add_notification(
        user_id=user_data1['id'],
        notification_type=NotificationType.FRIEND_REQUEST,
        message="Test notification"
...
def test_delete_notification(notification_repo, user_data1):
    notification = notification_repo.add_notification(
        user_id=user_data1['id'],
        notification_type=NotificationType.FRIEND_REQUEST,
        message="Test notification"
...
def test_nonexistent_notification(notification_repo):
    fake_id = uuid.uuid4()
...
def test_add_notification_with_related_object(notification_repo, user_data1):
