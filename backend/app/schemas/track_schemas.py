...
class TrackBase(BaseModel):
    spotify_id: str = Field(..., description="ID трека на Spotify")
    ...
    album_image_url: str | None = Field(None, description="URL обложки альбома")
    duration_ms: int = Field(..., description="Длительность трека в миллисекундах")
    external_url: str | None = Field(None, description="Ссылка на трек на Spotify")
