...
class CreateMessage:
    ...
    def create_message(self,room_id: uuid.UUID,user_id: uuid.UUID,message: str) -> MessageEntity | list:
        """
        ...
        try:
            new_message = self.chat_repo.create_message(room_id,user_id,message)
